    ...
    <main className="min-h-screen bg-gradient-to-br from-green-950 via-green-900 to-green-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-green-200 text-sm">🏢 Create your organization account</p>
          <p className="text-green-300 text-xs mt-1">Manage civic programs & verify citizen activities</p>
        </div>
        ...
        <div className="text-center mt-6">
          <Link href="/sign-up" className="text-green-200 text-sm hover:text-yellow-400">
            ← Back to role selection
          </Link>
        </div>
