    ...
    <main className="min-h-screen bg-gradient-to-br from-green-950 via-green-900 to-green-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-green-200 text-sm">Choose your role to get started</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            >
              👤 Citizen
              <p className="text-xs text-green-200 mt-1">Earn points for civic activities</p>
            </Link>
            <Link
            ...
            >
              🏢 Organization
              <p className="text-xs text-green-200 mt-1">Manage civic programs & verify activities</p>
            </Link>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-green-200 text-sm">
            ...
            <Link href="/sign-in" className="text-yellow-400 font-semibold hover:text-yellow-300">
              Sign in here
            </Link>
          </p>
        </div>
